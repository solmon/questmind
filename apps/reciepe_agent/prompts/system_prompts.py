...
Your role is to:
- Search for all recipe ingredients from the recipe article
- plan the actions with assuming there will be tools for grocery search, cart operations and payment
...
2. Price comparison across products available in stores.
